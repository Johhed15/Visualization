...
```{r, fig.cap='Scatter plot with continuous color scale for the amount of Linoleic'}
# loading the data
...
```{rfig.cap='Scatter plot with discrete color scale for the intervals of the amount Linoleic'}
...
### a 
```{r, warning=FALSE,fig.cap='Scatter plot with discrete color scale for the intervals of the amount Linoleic'}
...
### b
```{r, warning=FALSE,fig.cap='Scatter plot with size for the intervals of Linoleic'}
...
```{r,fig.cap='Scatter plot with continous color scale for Region'}
...
```{r,fig.cap='Scatter plot with discrete color scale for Regions'}
...
```{r, fig.cap='Scatterplot with 27 different types of observations', warning=FALSE}
...
```{r, fig.cap='Scatterplot with 27 different types of observations where color is defined by Region', warning=FALSE}
...
```{r,fig.cap='Pie chart over the propotions of oils for the Areas', warning=FALSE}
...
```{r, fig.cap='2d-density contour plot'}
...
```{r, fig.cap='2d-density contour plot combined with a scatterplot'}
